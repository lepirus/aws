...
```bash
Name of the project$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
Name of the project$ sam local start-api
Name of the project$ curl http://localhost:3000/
```
...
```bash
Name of the project$ sam logs -n HelloWorldFunction --stack-name Name of the project --tail
```
...
```bash
Name of the project$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name Name of the project
```
